(function () {
  ...
  var labels = ['L-1', 'L-2', 'L-3', 'L-4', 'L-5', 'L-6', 'L-7', 'L-8', 'L-9', 'L-10'];
  var data = [12, 9, 7, 6, 5, 4, 3, 2, 1, 1];
  var gold = 'rgba(212, 175, 55, 0.95)';
  var goldBorder = 'rgba(245, 230, 163, 0.6)';
  var silver = 'rgba(230, 230, 230, 0.95)';
  var silverBorder = 'rgba(255, 255, 255, 0.5)';
